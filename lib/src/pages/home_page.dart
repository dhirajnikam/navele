...
import 'package:maa/src/model/dactor_model.dart';
import 'package:maa/src/model/data.dart';
...
class HomePage123 extends StatefulWidget {
  @override
  _HomePage123State createState() => _HomePage123State();
}

class _HomePage123State extends State<HomePage123> {
  ...
  Widget _header() {
    return Column(
      ...
      children: <Widget>[
        ...
        Text("Rucha Ambale ", style: TextStyles.h1Style),
      ],
    ).p16;
  }
