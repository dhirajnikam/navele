...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      name: 'Neurogen',
      iconImage: 'assets/heart6.png',
      description:
          "Having an ability to tweek nerurons, Neurogen is one the difficult JOB a person can have. Damaging a single neuron can risk the life of the person.",
      precautions:
          "(1)car accidents that cause central nervous system damage or spinal cord injury     (2)sport injuries causing trauma to the spine  gunshot wounds to the spine     (3)medications that affect the autonomic nervous system, which regulates breathing and other automatic bodily functions     (4)improper administration of anesthesia to the spinal cord",
      images: [
  ...
  PlanetInfo(2,
      ...
      iconImage: 'assets/heart6.png',
      description:
          "Heart Attack is one of the major serious problems that a person can have by just living an unhealthy lifestyle. Heart attacks have been a common problem for many people, seeing many poeple recover to it on a faster rate, ennumber of people have succcumed to it. Best way to avoid Heart attacks is by avoiding unhealthy and oily foods, and doing exercise on a daily basis.",
      images: [
